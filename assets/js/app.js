    ...
    mouseenter: function() {
      if (s.post.length) {
        var currentIdx = 0,
            prevIdx = currentIdx;
            currentText = "";
            previewHead = document.getElementsByClassName('previews_head')[0];
        ...
        [].forEach.call(s.post, function(preview, idx) {
          preview.addEventListener('mouseenter', function() {
            ...
            if (prevIdx !== currentIdx) {
              ...
              // Alter text
              currentText = s.post[currentIdx].getElementsByTagName('h2')[0].innerHTML;
              previewHead.innerHTML = currentText;
            }
          });
        });
      }
